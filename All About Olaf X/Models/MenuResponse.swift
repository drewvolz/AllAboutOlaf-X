...
public struct MenuResponse: Hashable, Identifiable, Encodable, Decodable {
    ...
    struct Day: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case date
            case cafes
        }
    ...
    struct Cafe: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case name
            case menuID
            case dayparts
    ...
    struct Daypart: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case starttime
            case endtime
            case id
    ...
    struct StationElement: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case orderID
            case id
            case label
    ...
    struct NutritionValues: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case label
            case value
            case unit
    ...
    struct Nutrition: Hashable, Encodable, Decodable {
        enum CodingKeys: String, CodingKey {
            case calories
            case servingSize
            case fatContent
